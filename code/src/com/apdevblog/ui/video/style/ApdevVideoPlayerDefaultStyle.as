package com.apdevblog.ui.video.style 
{
	...
	public class ApdevVideoPlayerDefaultStyle 
	{
		 ...
		 */
		public var bgGradient1:uint = 0x010101;
		 ...
		 */
		public var btnGradient1:uint = 0x555555;

		/**
		 * btn's background gradient color bottom
		 */
		public var btnGradient2:uint = 0x222222;
		 ...
		 */
		public var btnRollOverGlow:uint = 0xCCCCCC;

		/**
		 * btn's icon glow alpha
		 */
		public var btnRollOverGlowAlpha:Number = 0.5;
		 ...
		 */
		public var timerUp:uint = 0x000000;
		
		/**
		 * text color when timer is counting down
		 */
		public var timerDown:uint = 0x888888;
		 ...
		 */
		public var barBg:uint = 0xF4F4F4;
		 ...
		 */
		public var barLoading:uint = 0xC8C8C8;
		
		/**
		 * background color of time-bar (playing)
		 */
		public var barPlaying:uint = 0x2F2F2F;
		 ...
		 */
		public var controlsPaddingLeft:uint = 20;
		
		/**
		 * videocontrols padding right side (in pixel)
		 */
		public var controlsPaddingRight:uint = 20;
