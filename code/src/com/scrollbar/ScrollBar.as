package com.scrollbar {
	...
	public class ScrollBar extends MovieClip {
		...
		private function onTrackDownHandler(e:MouseEvent):void {
			...
			Tweener.addTween(thumb_mc, { y:nPos, time: 0.1, onUpdate:function():void { onChangeScrollPos(null) }} );
			
			thumb_mc.startDrag(false, new Rectangle(thumb_mc.x, 0, 0, track_mc.height-thumb_mc.height));
